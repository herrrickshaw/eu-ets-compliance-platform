...
# ---- Shipping MRV: real EU ETS compliance cost ----
class ShippingEtsComplianceCostOut(OrmBase):
    id: int
    category: str
    metric_label: str
    period: str
...
# ---- Trading: real EUA/carbon-derivatives market stats ----
class EuaTradingMarketStatOut(OrmBase):
    id: int
    category: str
    metric_label: str
    period: str
